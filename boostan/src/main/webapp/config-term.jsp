...
<head>
    ...
    <%--Command Operational--%>
    <title>Config Term</title>
    <link rel="favicon" href="favicon.ico"/>
    <!-- Tell the browser to be responsive to screen width -->
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">

    <script>
        var isCreationConfigTerm = true;
    </script>
...
<div class="content-wrapper" style="min-height: 670px;width: 80%;right: 0;float: right;margin: 5px;">
    ...
    <section class="content-header">
        ...
        <h1 id="pageHeader" lang="en">Config Term list</h1>

        <ol class="breadcrumb">
            <li class="active" lang="en"><i class="fa fa-dashboard"></i>Config Term list</li>
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="box-body">
                    ...
                    <table id="ConfigTermList" class="table table-bordered table-striped"
                           style="direction:rtl;">
                        <thead>
                        ...
                        <tr>
                            ...
                            <th lang="en">term</th>
                            <th lang="en">year</th>
                            <th lang="en">min_unit</th>
                            <th lang="en">max_unit</th>
                            <th lang="en">start_date</th>
                            <th lang="en">end_date</th>
                            <th lang="en">is_active</th>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"
                            onclick=clearDataModalConfigTerm()>
                        <span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" lang="en">Config Term</h4>
                </div>
                <div class="modal-body">

                    <div class="row">
                        <div class="col-xs-12">
                            <label lang="en" style="width: 100%">term</label><select type="text" id="term" class="col-md-9" style="width: 50%" dir="rtl"></select>
                            <br><br>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
                            <label lang="en" style="width: 100%">year</label><select type="text" id="year" class="col-md-9" style="width: 50%" dir="rtl"></select>
                            <br><br>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
                            <label lang="en">min_unit</label><input type="text" id="min_unit" class="col-md-9">
                            <br><br>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
                            <label lang="en">max_unit</label><input type="text" id="max_unit" class="col-md-9">
                            <br><br>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
                            <label lang="en" style="float: right;width: 100%">
                                start_date</label>
                            <div class="input-group" style="direction: ltr">
                                <div class="input-group-addon" data-mddatetimepicker="true"
                                     data-EnableTimePicker="true"
                                     data-targetselector="#start_date" data-trigger="click"
                                     data-isgregorian="false" data-EnglishNumber="true">
                                    <span class="glyphicon glyphicon-calendar" style="margin: 5%"></span>
                                </div>
                                <input type="text" class="col-md-8" id="start_date" style="width: 100%"
                                       placeholder="تاریخ"/>
                            </div>
                            <br><br>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div class="input-group" style="direction: ltr">
                                <div class="input-group-addon" data-mddatetimepicker="true"
                                     data-EnableTimePicker="true"
                                     data-targetselector="#end_date" data-trigger="click"
                                     data-isgregorian="false" data-EnglishNumber="true">
                                    <span class="glyphicon glyphicon-calendar" style="margin: 5%"></span>
                                </div>
                                <input type="text" class="col-md-8" id="end_date" style="width: 100%"
                                       placeholder="تاریخ"/>
                            </div>
                            <br><br>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <%--<label lang="en">is_active</label><input type="text" id="is_active" class="col-md-9">--%>


                            <div class="checkbox">
                                <label><input  id="is_active" type="checkbox" value=""><span lang="en">is_active</span></label>
                            </div>
                            <br><br>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    <div class="modalBtn">
                        <button id="modalOk" type="submit" class="btn btn-modal pull-left bg-olive margin"
                                ...
                                onclick="saveOrUpdateConfigTerm();" data-dismiss="modal"
                                lang="en">Save
                        </button>
                        <button type="button" class="btn btn-modal btn-secondary pull-left btn-danger margin"
                                data-dismiss="modal" lang="en" onclick="clearDataModalConfigTerm()">Cancel
                        </button>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-footer">
                    <div class="modalBtn">
                        <button id="modaldelete" type="submit" class="btn btn-modal pull-left bg-olive margin"
                                onclick='deleteRowConfigTerm();refreshDataTableConfigTerm();' data-dismiss="modal" lang="en">Yes
                        </button>
                        <button type="button" class="btn btn-modal btn-secondary pull-left btn-danger margin"
...
<script type="text/javascript" src="dist/js/selectionUnit/Boostan-Config-Term-Manager.js"></script>
<script type="text/javascript" src="dist/js/selectionUnit/services/Boostan-Config-Term.js"></script>
