...
<head>
    ...
    <link rel="stylesheet" href="plugins/yadcf/select2.css"></head>
...
<div class="content-wrapper" style="min-height: 670px;width: 80%;right: 0;float: right;margin: 5px;">
    ...
    <section class="content-header">
        ...
        <h1 id="pageHeader" lang="en">Course list</h1>

        <ol class="breadcrumb">
            <li class="active" lang="en"><i class="fa fa-dashboard"></i>Course list</li>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"
                            onclick=clearDataModalCourse()>
                        <span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" lang="en">Course</h4>
                </div>
                <div class="modal-body">

                             <div class="row">
        <div class="col-xs-12">
<label lang="en">name</label><input type="text" id="name" class="col-md-9">
<br><br>
         </div>
         </div>
         <div class="row">
        <div class="col-xs-12">
<label lang="en">description</label><input type="text" id="description" class="col-md-9">
<br><br>
         </div>
         </div>
         <div class="row">
        <div class="col-xs-12">
<label lang="en">unit</label><input type="text" id="unit" class="col-md-9">
<br><br>
         </div>
         </div>
         <div class="row">
        <div class="col-xs-12">
<label lang="en">prerequisite</label><input type="text" id="prerequisite" class="col-md-9">
<br><br>
         </div>
         </div>
                ...
                <div class="modal-footer">
                    <div class="modalBtn">
                        <button id="modalOk" type="submit" class="btn btn-modal pull-left bg-olive margin"
                                ...
                                onclick="saveOrUpdateCourse();" data-dismiss="modal"
                                lang="en">Save
                        </button>
                        <button type="button" class="btn btn-modal btn-secondary pull-left btn-danger margin"
                                data-dismiss="modal" lang="en" onclick="clearDataModalCourse()">Cancel
                        </button>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-footer">
                    <div class="modalBtn">
                        <button id="modaldelete" type="submit" class="btn btn-modal pull-left bg-olive margin"
                                onclick='deleteRowCourse();refreshDataTableCourse();' data-dismiss="modal" lang="en">Yes
                        </button>
                        <button type="button" class="btn btn-modal btn-secondary pull-left btn-danger margin"
...
<script type="text/javascript" src="dist/js/selectionUnit/services/Boostan-Course.js"></script>
...
<script type="text/javascript">
//    var lang = new Lang();
////    lang.dynamic('fa', 'http://localhost:8080/plugins/jquery-lang-js/js/langpack/boostan_fa.js');
//    window.lang.dynamic('fa', 'plugins/jquery-lang-js/js/langpack/boostan_fa.js');
////    lang.init({
////        defaultLang: 'en'
////    });
//    window.lang.init({
