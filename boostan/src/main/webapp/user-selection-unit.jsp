...
<head>
    ...
    <%--Command Operational--%>
    <title>User Selection Unit</title>
                    ...
                    <form id="frmButtons" role="form">
                        ...
                        <div id="frmButtonsSection">
                            ...
                            <a id="advancedBtnPlan" class="btn btn-block bg-orange pull-right" data-toggle="collapse"
                               ...
                               lang="en">Advanced</a>
                            <button id="adddSelectedLesson" type="button" class="btn btn-block bg-blue pull-right"

                                    onclick="addSelectedLesson();refreshDataTableUserLesson();"
                                    style="width: 105px;margin-top: 10px;margin-left: 10px;"><span lang="en">Add Lesson</span>
                            </button>
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="row">
                    ...
                    <form id="frmButtonsUserUnits" role="form">
                        <h3 style="float: right; right: 0;"><span lang="en">User Lesson</span></h3><br>
                        <%--<h5 style="float: right; right: 0;"><span lang="en">Condition Finilize</span></h5><br>--%>
                        <div id="frmButtonsSectionUserUnits">

                            <a id="UserUnitsadvancedBtnPlan" class="btn btn-block bg-orange pull-right" data-toggle="collapse"
                               data-target=".btn-group" style="width: 105px;margin-top: 10px;margin-left: 10px;"
                               lang="en">Advanced</a>

                            <button id="removeSelectedLesson" type="button" class="btn btn-block bg-blue pull-right"

                                    onclick="salamSelectedLesenRemove();"
                                    style="width: 105px;margin-top: 10px;margin-left: 10px;" ><span lang="en">Delete Lesson</span>
                            </button>
                            <button id="finalizeSelection" type="button" class="btn btn-block bg-green pull-right"

                                    onclick="byeFinalizeSelection();"
                                    style="width: 155px;margin-top: 10px;margin-left: 10px;"><span lang="en">Finalize Selection</span>
                            </button>
                            <%--onclick="alert('salam!');removeSelectedLesson();alert('salam!');refreshDataTableUserLesson();"--%>
                            <span style="padding-top:5px; font-size: 12px;color: #ff1745; ">
                                ${message}
                            </span>
                        </div>
                    </form>
                ...
                <div class="box-body">
                    ...
                    <table id="LessonListUserUnits" class="table table-bordered table-striped"
                           style="direction:rtl;">
                        <thead>
...
<script type="text/javascript" src="dist/js/selectionUnit/services/Boostan-User-Lesson.js"></script>
